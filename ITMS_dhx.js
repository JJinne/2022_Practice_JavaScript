	        ...
	        switch (id) {
                ...
                case "M050602": //IT 구매/계약 관리
                    ...
                    dhxLayout1 = dhxLayout.cells("b").attachLayout({
                        pattern: "2U",
                        cells: [
                            { id: "a", text: "<div style='float:left; padding:6px 0 0 0;'><img src='/IMAGES/ICO/Dhx/106.png' width='20'></div><div style='float:left; padding:0 0 0 10px;'>" + nStr + "</div>", collapsed_text: nStr, header: true, fix_size: [false, false], width: 650 },
                            { id: "b", text: "<div style='float:left; padding:0 0 0 10px;'>"+"IT 구매/계약 상세 이력" + "</div>", collapsed_text: "", header: true, fix_size: [false, false]}
                        ]
                    });
...
function DhxToolbar_IT_DealList(){
    ...
    dhxToolbar.setAlign("right");
    dhxToolbar.setIconsPath("/IMAGES/ICO/");
    dhxToolbar.addButton("Reg",60,"등록","/32/754.png","");
    dhxToolbar.addButton("Del", 60, "삭제", "/32/628.png", "");
    dhxToolbar.attachEvent("onClick", function (id) {
        switch(id){
            case "Reg":
...
function DhxLayout_IT_Deal_Record(){
    ...
    dhxGrid_1.setInitWidthsP("0,0,13,7,15,20,15,15,15");
    dhxGrid_1.setColAlign("left,left,center,right,right,left,center,center,right");
    ...
    dhxGrid_1.clearAndLoad("/MODULE/ITMS/DATA/XmlForGrid_IT_Deal_Record_List.asp?CD_MST=" + nCdMst, function(){
        dhxGrid_1.forEachRow(function(id){
        });
    });
